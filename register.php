...
<body>
    <form action="register_act.php" method="POST">
        ...
        <div class="main-wrapper">
            ...
            <dl class="form-inner2">
                ...
                <dd class="inner-detail2"><input type="text" name="username" class="form-parts"></dd>
                ...
                <div class="btn">
                    <button class="intro-btn-post">ユーザー登録</button>
                </div>
            </dl>
        </div>
    </form>
    <div class="btn-wrapper">
        <div class="btn">
            <a href="login.php">
                <button class="btn-post">登録済みの方はこちら</button>
            </a>
        </div>
        <div class="btn">
            <a href="index.php">
    ...
    <!-- フッター -->
    <footer>
        <p>© pozitore All Rights Reserved.</p>
    </footer>
</body>
